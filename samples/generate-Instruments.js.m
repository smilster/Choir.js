...
function main()
  ...
  % output String will be wrirrten to outputFile at the end of main()
  outputFile = 'Instruments.js';
  % start file with a blank line
  output = [newline];
  %% make some comment in JS file
  output = [output '//this file is auto generated by ' parentFolder '/' mfilename() '.m' newline newline];
  ...
  output = [output "\t\tconst serverUrl = window.location;" newline newline ];
